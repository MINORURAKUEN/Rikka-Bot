...
- Video MP4 (enviado como video reproducible)
- MKV, AVI, MOV, WEBM (enviados como archivo/documento)
...
async def handle_url(client, message: Message):
    ...
    try:
        ...
        if success and file_path:
            ...
            try:
                if file_ext in ['.mp4']:  # Solo MP4 como video
                    ...
                    # MKV, AVI, MOV, WEBM y otros como documento
